...
<%@include file="menu.jsp" %>
 <div class="row gx-lg-9">
            <div class="col-xl-8 border-end-xl border-300">
              <div class="card mb-9">
                <div class="card-body">
                  <h1 class="lh-sm fs-2 fs-xxl-4 mb-2">${customer.username}</h1>
                  <p class="fs-0 mb-4 text-600">${customer.cname}</p>
                          ...
                          <div>
                            <div class="mb-3">
                              <div class="d-flex align-items-center">
                                ...
                                <h5 class="ms-2 text-1100 mb-0">${customer.ctel}</h5>
                              </div>
                            </div>
                  ...
                  <div class="row g-2">
                   ...
                   <div class="col-12 col-sm-auto flex-sm-grow-1 flex-md-grow-0">
                    ...
                    <div class="col-6 col-sm-auto">
                      <a href="/update?bno=${customer.cno}" class="btn btn-phoenix-primary w-100"><span class="fa-solid fa-heart me-2"></span>수정</a>
                    
                    </div>
                    <div class="col-6 col-sm-auto">
                      <a href="/delete?bno=${customer.cno}" class="btn btn-phoenix-danger w-100"><span class="fa-solid fa-share-nodes me-2"></span>삭제</a>
