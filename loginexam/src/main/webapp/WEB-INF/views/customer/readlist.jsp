                ...
                <c:forEach items="${customer}" var="customer">
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="customer align-middle white-space-nowrap"><a class="d-flex align-items-center text-900 text-hover-1000" href="#!">
                        ...
                        <h6 class="mb-0 ms-3 fw-semi-bold">${customer.bno}</h6>
                      </a></td>
                    <td class="email align-middle white-space-nowrap"><a class="fw-semi-bold" href="/readdetail?bno=${customer.bno}">${customer.btitle}</a></td>
                    <td class="mobile_number align-middle white-space-nowrap"><a class="fw-bold text-1100" href="tel:+912346578">${customer.bwriter}</a></td>
                    <td class="city align-middle white-space-nowrap text-900">${customer.bdate}</td>
