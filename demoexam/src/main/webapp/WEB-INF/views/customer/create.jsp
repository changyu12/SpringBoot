        ...
        <div class="row flex-center min-vh-100 py-5">
          <div class="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3"><a class="d-flex flex-center text-decoration-none mb-4" href="../../../index.html">
            ...
            <div class="mb-3 text-start">
              ...
              <div class="form-icon-container">
                <input class="form-control form-icon-input" name="cname" type="cname" placeholder="닉네임을 입력하세요" /><span class="fas fa-key text-900 fs--1 form-icon"></span>
              </div>
            </div>
            ...
            <div class="mb-3 text-start">
              ...
              <div class="form-icon-container">
                <input class="form-control form-icon-input" name="cimg" type="cimg" placeholder="cimg" /><span class="fas fa-key text-900 fs--1 form-icon"></span>
              </div>
            </div>
